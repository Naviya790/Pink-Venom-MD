...
module.exports = {
    SESSION_ID: process.env.SESSION_ID === undefined ? 'PINKVENOM-MD;qMlXWYIB#ftcVvO0Gv1234BYpZydrIp5BBWwrr2wnbsM5hw7ybwo' : process.env.SESSION_ID, //ADD YOUR SESSION ID
    GITHUB_USER_NAME: process.env.GITHUB_USER_NAME === undefined ? 'Naviya790' : process.env.GITHUB_USER_NAME, //ADD YOUR GITHUB USERNAME
    GITHUB_AUTH_TOKEN: process.env.GITHUB_AUTH_TOKEN === undefined ? 'GgoxFWWqFSUqZiWPVGTtm662NA9dDg3E5hgR' : process.env.GITHUB_AUTH_TOKEN, //ADD YOUR GITHUB AUTH TOKEN WITHOUT gph_ ,  example - G5OxxdvEbiBPWxm4A0xypQGlyCr4FS267ifz
